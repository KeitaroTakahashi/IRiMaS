...
void IRSpectrogramUI::mouseDownHandler(const MouseEvent& e)
{
...
void IRSpectrogramUI::mouseUpHandler(const MouseEvent& e)
{
...
void IRSpectrogramUI::mouseDragHandler(const MouseEvent& e)
{
...
// ------------------------------------------------------------
/*
void IRSpectrogramUI::playSelectedArea()
{
    for(auto obj : this->selectedSquareObjectList)
    {
...
// ------------------------------------------------------------
/*void IRSpectrogramUI::stopPlaying()
{
